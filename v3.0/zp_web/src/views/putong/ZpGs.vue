<template>
    <div class="app_data">
        ...
        <div class="update">
            <div id="main" style="width: 40%; height: 400px;display: inline-block;border-right: #fff 2px solid;"></div>
            <div id="main2" style="width: 60%; height: 400px;display: inline-block;"></div>
        </div>
...
export default {
    ...
    methods: {
        ...
        async init() {
            ...
            const {data:res} = await gsinfo(`search=${this.searchParams.search}&type=${this.searchParams.type}&location=${this.searchParams.location}&xueli=${this.searchParams.xueli}`);
            this.eData = res.info
