<template>
    <div class="app_data">
        ...
        <div class="query-c">
            <Form inline>
                <FormItem>
                    <Select v-model="searchParams.search" style="width:200px" placeholder="请选择统计类型" clearable filterable>
...
<script>
import {tszpcity,tsXueli,tsjingyan} from "../../api/teshu";
...
export default {
    ...
    methods: {
        ...
        // 数据查询
        async init() {
            const {data:res} = await tszpcity(this.searchParams);
