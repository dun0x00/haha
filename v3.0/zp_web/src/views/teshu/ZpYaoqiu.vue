...
import {getTsDatas,delTsData,tsXueli,tsjingyan,yaoqiuTs} from "../../api/teshu";
...
export default {
    ...
    methods: {
        ...
        async init() {
            const {data:res} = await yaoqiuTs(`search=${this.searchParams.search}&location=${this.searchParams.location}`);
            // console.log(res)
            this.eData = res.info
