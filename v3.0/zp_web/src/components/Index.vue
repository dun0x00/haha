    ...
    <div class="index-vue">
        ...
        <aside :class="asideClassName">
            ...
            <div class="logo-c">
                ...
                <span v-show="isShowAsideTitle">招聘信息可视化系统</span>
            </div>
            <!-- 菜单栏 -->
            ...
            accordion :open-names="openMenus" :active-name="currentPage" @on-open-change="menuChange">
                ...
                <div v-for="(item, index) in menuItems" :key="index">
                    <Submenu :class="isShowAsideTitle? '' : 'shrink'" v-if="item.children && item.role === userRole" :name="index">
                        <template slot="title">
                    ...
                    <template v-else-if="!item.hidden && item.role === userRole">
